...
CXX = g++
CXXFLAGS = -std=c++20 -Wall -I./deps -I./include -I$(PROTO_BUILD_DIR) 
...
$(TEST_EXECUTABLE): $(TEST_OBJECTS) $(NON_MAIN_OBJECTS) | $(TEST_BUILD_DIR)/.dir $(BUILD_DIR)/.dir
...
$(TEST_BUILD_DIR)/%: $(TEST_BUILD_DIR)/%.it.o $(NON_MAIN_OBJECTS) | $(TEST_BUILD_DIR)/.dir $(BUILD_DIR)/.dir
	@echo "Linking integration $@..."
	$(CXX) $(CXXFLAGS) -o $@ $(NON_MAIN_OBJECTS) $< $(LDFLAGS) $(OPENCV_LIBS)

$(PROTO_BUILD_DIR)/%.pb.o: $(PROTO_BUILD_DIR)/%.pb.cc | $(PROTO_BUILD_DIR)/.dir
	@echo "Compiling Protobuf source $< -> $@"
	$(CXX) $(CXXFLAGS) -c $< -o $@

$(PROTO_HEADER) $(PROTO_SOURCE): $(PROTOS_DIR)/onboarding.proto | $(PROTO_BUILD_DIR)/.dir
...
$(PROTO_BUILD_DIR)/.dir: | $(BUILD_DIR)/.dir
	@mkdir -p $(PROTO_BUILD_DIR)
	@touch $@

$(TEST_BUILD_DIR)/.dir: | $(BUILD_DIR)/.dir
